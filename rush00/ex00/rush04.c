...
/*   Updated: 2022/07/03 17:47:53 by jjunttil         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// In our case the character 'A' should be printed in the upper left
// and lower right corners, the character 'C' in the lower left and
// the upper right corners, the character 'B' in the sides,
// and the space inside the rectangle.
void	print(int x, int y, int c_width, int c_height)
{
	if ((c_height == 0 && c_width == 0)
		|| (c_width == (x - 1) && c_height == (y -1)))
	{
		ft_putchar('A');
	}
	else if ((c_height == (y - 1) && (c_width == 0))
		|| (c_width == (x - 1) && c_height == (0)))
	{
		ft_putchar('C');
	}
